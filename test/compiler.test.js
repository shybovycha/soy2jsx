const { compileCode, compileFile } = require('../src/compiler');
...
describe('compiler', () => {
  ...
  describe('#compileFile', () => {
    describe('for simple SOY templates', () => {
      it('does not fail', () => {
        expect.assertions(0);
        compileFile('test/sample_data/sample.soy', { writeJsxAst: true, writeSoyAst: true }).catch(e => expect(e).toBeFalsy());
      });
    });
  });
});
